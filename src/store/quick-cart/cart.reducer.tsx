...
export function cartReducer(state: State, action: Action): State {
  console.log('Reducer called with action:', action); // Log action
  switch (action.type) {
    ...
    case 'ADD_ITEM_WITH_QUANTITY': {
      ...
      console.log('ADD_ITEM_WITH_QUANTITY',state.items,action.item,action.quantity)
      return generateFinalState(state, items);
    }
    case 'REMOVE_ITEM_OR_QUANTITY': {
      ...
      console.log('REMOVE_ITEM_OR_QUANTITY',state.items,action.id)
      return generateFinalState(state, items);
    }
    case 'ADD_ITEM': {
