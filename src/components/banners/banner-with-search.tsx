    ...
    >
      <div className="-z-1 overflow-hidden">
        <div className="relative">
          ...
          <div style={{zIndex:10, marginTop: '35%',width:'50%',marginRight: 'auto', marginLeft: 'auto',height:'132px'}} className="absolute inset-0 mt-8 flex flex-col items-center justify-center p-5 text-center md:px-20 lg:space-y-10">
